...
. *Update the Next.js Preview configuration file* for your Enonic installation by adding multiple entries:
+
...
+
.com.enonic.app.preview.nextjs.cfg
[source,properties]
----
...
+
. *Assign the configuration to your site* by clicking the pencil icon next to the `Next.js Preview` app name in the site form, and selecting it from the list of named configurations:
+
