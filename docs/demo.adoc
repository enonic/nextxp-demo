...
. After logging in to your account, **create a new solution** from `Solutions -> Create -> Headless Movie DB - Demo`. This will install all required Enonic apps and setup the routes needed. 
