...
== Task: Publish page
Your fresh new page is looking good. However, if you visit `http://localhost:3000` - you'll get a "404 page not found" error. This is because only published changes are visible from the front end
...
+
. **Verify that your page is live** by visiting `http://localhost:3000` once again.
