...
----
+
NOTE: `intro` is the name of the project. `tutorial.nxp` refers to the name of the application you created in the previous chapter. `movie` is a specific content type within the app.
+
. **View the Result**
+
