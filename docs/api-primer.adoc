...
[NOTE]
====
The API can be accessed directly following URL: http://localhost:8080/api/com.enonic.app.guillotine:graphql[http://localhost:8080/api/com.enonic.app.guillotine:graphql^].

`intro` is the name of your Content Studio project.
====
...
<1> Notice how `imageUrl` is requested with parameters of its own?
